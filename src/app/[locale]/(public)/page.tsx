...
export default async function HomePage({ params }: HomeProps) {
  ...
  const regularPartners = [
    ...
    { logo: '/images/partners/regular_3tv.png' },
    ...
    { logo: '/images/partners/regular_b24.png' },
    { logo: '/images/partners/partner_row5_1.png' },
    { logo: '/images/partners/partner_row5_2.png' },
    { logo: '/images/partners/regular_afriyelba.png' },
    { logo: '/images/partners/regular_faso7.jpg' },
