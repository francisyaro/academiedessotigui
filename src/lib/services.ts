...
export const MOCK_NOMINEES: Nominee[] = [
  ...
  },
  {
    ...
    first_name: "Fatma",
    last_name: "SFAR",
    stage_name: "Fatma Sfar",
    slug: "fatma-sfar-2025",
    gender: "F",
    portrait_path: "/images/nominee_10_fatma_sfar.jpg",
    biography: "Fatma Sfar est une actrice tunisienne nommée dans la catégorie Sotigui du Meilleur Acteur de l'Afrique du Nord lors de la 10ème édition (2025) pour son rôle dans le long-métrage 'AICHA' de Mehdi Barsaoui.",
    short_biography: "Nominée pour le Meilleur Acteur de l'Afrique du Nord 2025.",
    country_id: "Tunisie",
    category_name: "Meilleur Acteur de l'Afrique du Nord",
    category_slug: "meilleur-acteur-afrique-nord",
    film_title: "AICHA",
  ...
  },
  {
    ...
    first_name: "Sammy",
    last_name: "LECHEA",
    stage_name: "Sammy Lechea",
    slug: "sammy-lechea-2025",
    gender: "M",
    portrait_path: "/images/nominee_10_sammy_lechea.jpg",
    biography: "Sammy Lechea est un acteur algérien nommé dans la catégorie Sotigui du Meilleur Acteur de l'Afrique du Nord lors de la 10ème édition (2025) pour son rôle dans le long-métrage 'L'EFFACEMENT' de Karim Moussaoui.",
    short_biography: "Nominé pour le Meilleur Acteur de l'Afrique du Nord 2025.",
    country_id: "Algérie",
    category_name: "Meilleur Acteur de l'Afrique du Nord",
    category_slug: "meilleur-acteur-afrique-nord",
    film_title: "L'EFFACEMENT",
    film_slug: "l-effacement",
    is_winner: false,
    is_public_vote_eligible: true
  },
  {
    ...
    gender: "F",
    portrait_path: "/images/nominee_10_nisrin_erradi.jpg",
    biography: "Nisrin Erradi est une actrice marocaine nommée dans la catégorie Sotigui du Meilleur Acteur de l'Afrique du Nord lors de la 10ème édition (2025) pour son incarnation magistrale dans le long-métrage 'EVERYBODY LOVES TOUDA' de Nabil Ayouch.",
    short_biography: "Nominée pour le Meilleur Acteur de l'Afrique du Nord 2025.",
    country_id: "Maroc",
    category_name: "Meilleur Acteur de l'Afrique du Nord",
    category_slug: "meilleur-acteur-afrique-nord",
  ...
  },
  {
    ...
    slug: "mahamady-nana-2025",
    gender: "M",
    portrait_path: "/images/nominee_10_mahamady_nana.jpg",
    biography: "Mahamady Nana est un acteur burkinabè nommé dans la catégorie Sotigui du Meilleur Acteur de l'Afrique de l'Ouest lors de la 10ème édition (2025) pour son rôle dans le long-métrage 'KATANGA, LA DANSE DES SCORPIONS' de Dani Kouyaté.",
    short_biography: "Nominé pour le Meilleur Acteur de l'Afrique de l'Ouest 2025.",
    country_id: "Burkina Faso",
    category_name: "Meilleur Acteur de l'Afrique de l'Ouest",
    category_slug: "meilleur-acteur-afrique-ouest",
    film_title: "KATANGA, LA DANSE DES SCORPIONS",
    film_slug: "katanga-la-danse-des-scorpions",
    is_winner: false,
    is_public_vote_eligible: true
  },
  {
    ...
    first_name: "Arthur",
    last_name: "LONGVILLE",
    stage_name: "Arthur Longville",
    slug: "arthur-longville-2025",
    gender: "M",
    portrait_path: "/images/nominee_10_arthur_longville.jpg",
    biography: "Arthur Longville est un acteur ivoirien nommé dans la catégorie Sotigui du Meilleur Acteur de l'Afrique de l'Ouest lors de la 10ème édition (2025) pour son rôle dans le long-métrage 'LE SACRIFICE' de Landry Agbadou.",
    short_biography: "Nominé pour le Meilleur Acteur de l'Afrique de l'Ouest 2025.",
    country_id: "Côte d'Ivoire",
    category_name: "Meilleur Acteur de l'Afrique de l'Ouest",
    category_slug: "meilleur-acteur-afrique-ouest",
    film_title: "LE SACRIFICE",
    film_slug: "le-sacrifice",
    is_winner: false,
    is_public_vote_eligible: true
  },
  {
    ...
    gender: "M",
    portrait_path: "/images/nominee_10_cheikh_babou_gaye.jpg",
    biography: "Cheikh Babou Gaye est un acteur sénégalais nommé dans la catégorie Sotigui du Meilleur Acteur de l'Afrique de l'Ouest lors de la 10ème édition (2025) pour sa remarquable prestation dans le long-métrage 'NANAS' de Khalifa Ba.",
    short_biography: "Nominé pour le Meilleur Acteur de l'Afrique de l'Ouest 2025.",
    country_id: "Sénégal",
    category_name: "Meilleur Acteur de l'Afrique de l'Ouest",
    category_slug: "meilleur-acteur-afrique-ouest",
  ...
  },
  {
    ...
    slug: "wole-ojo-2025",
    gender: "M",
    portrait_path: "/images/nominee_10_wole_ojo.jpg",
    biography: "Wole Ojo est un acteur nigérian nommé dans la catégorie Sotigui du Meilleur Acteur Nigeria / Ghana lors de la 10ème édition (2025) pour sa prestation dans 'L'HOMME EST MORT' de Awam Amkpa.",
    short_biography: "Nominé pour le Meilleur Acteur Nigeria / Ghana 2025.",
    country_id: "Nigéria",
    category_name: "Meilleur Acteur Nigeria / Ghana",
    category_slug: "meilleur-acteur-nigeria-ghana",
    film_title: "L'HOMME EST MORT",
    film_slug: "l-homme-est-mort",
    is_winner: false,
    is_public_vote_eligible: true
  },
  {
    ...
    first_name: "Kwadwo",
    last_name: "NKANSAH",
    stage_name: "Kwadwo Nkansah (Lil Win)",
    slug: "kwadwo-nkansah-2025",
    gender: "M",
    portrait_path: "/images/nominee_10_kwadwo_nkansah.jpg",
    biography: "Kwadwo Nkansah (dit Lil Win) est un acteur ghanéen nommé dans la catégorie Sotigui du Meilleur Acteur Nigeria / Ghana lors de la 10ème édition (2025) pour son rôle dans le long-métrage 'CAPITAIN IBRAHIM TRAORE' de Jackson K. Bentum.",
    short_biography: "Nominé pour le Meilleur Acteur Nigeria / Ghana 2025.",
    country_id: "Ghana",
    category_name: "Meilleur Acteur Nigeria / Ghana",
    category_slug: "meilleur-acteur-nigeria-ghana",
    film_title: "CAPITAIN IBRAHIM TRAORE",
    film_slug: "capitain-ibrahim-traore",
    is_winner: true,
    is_public_vote_eligible: true
  },
  {
    ...
    first_name: "Nnamdi",
    last_name: "AGBO",
    stage_name: "Nnamdi Agbo",
    slug: "nnamdi-agbo-2025",
    gender: "M",
    portrait_path: "/images/nominee_10_nnamdi_agbo.jpg",
    biography: "Nnamdi Agbo est un acteur nigérian nommé dans la catégorie Sotigui du Meilleur Acteur Nigeria / Ghana lors de la 10ème édition (2025) pour son rôle marquant dans 'LE DETOURNEMENT (HIJACK 93)' de Robert O. Peters.",
    short_biography: "Nominé pour le Meilleur Acteur Nigeria / Ghana 2025.",
    country_id: "Nigéria",
    category_name: "Meilleur Acteur Nigeria / Ghana",
    category_slug: "meilleur-acteur-nigeria-ghana",
    film_title: "LE DETOURNEMENT (HIJACK 93)",
    film_slug: "le-detournement-hijack-93",
    is_winner: false,
    is_public_vote_eligible: true
  },
  {
    ...
    slug: "eve-guehi-2025",
    gender: "F",
    portrait_path: "/images/nominee_10_eve_guehi.jpg",
    biography: "Eve Guehi est une actrice ivoirienne, nominée dans la catégorie Meilleure Interprétation Féminine Africaine – Série TV lors de la 10ème édition (2025) pour sa prestation emblématique dans 'LES NOUNOUS' de Franck Vlehi & Marina Niava.",
    short_biography: "Lauréate du prix de la Meilleure Interprétation Féminine - Série TV 2025.",
    country_id: "Côte d'Ivoire",
    category_name: "Meilleure Interprétation Féminine Africaine – Série TV",
    category_slug: "meilleure-interpretation-feminine-serie-tv",
  ...
  },
  {
    ...
    first_name: "Hortavie",
    last_name: "MPONDO",
    stage_name: "Hortavie Mpondo",
    slug: "hortavie-mpondo-2025",
    gender: "F",
    portrait_path: "/images/nominee_10_hortavie_mpondo.jpg",
    biography: "Hortavie Mpondo est une actrice camerounaise, nominée dans la catégorie Meilleure Interprétation Féminine Africaine – Série TV lors de la 10ème édition (2025) pour son rôle dans la série 'REVELATIONS SCANDALEUSES' de Ebenezer Kepombia.",
    short_biography: "Nominée pour la Meilleure Interprétation Féminine - Série TV 2025.",
    country_id: "Cameroun",
    category_name: "Meilleure Interprétation Féminine Africaine – Série TV",
    category_slug: "meilleure-interpretation-feminine-serie-tv",
    film_title: "REVELATIONS SCANDALEUSES",
    film_slug: "revelations-scandaleuses",
    is_winner: false,
    is_public_vote_eligible: true
  },
  {
    id: "n118",
    year: 2025,
    first_name: "Keisha Khadija",
    last_name: "DEME",
    stage_name: "Keisha Khadija Deme",
    slug: "keisha-khadija-deme-2025",
    gender: "F",
    portrait_path: "/images/nominee_10_keisha_khadija_deme.jpg",
    biography: "Keisha Khadija Deme est une actrice sénégalaise, nominée dans la catégorie Meilleure Interprétation Féminine Africaine – Série TV lors de la 10ème édition (2025) pour son rôle dans la série 'KEY & ZA' de Peter Ayivor.",
    short_biography: "Nominée pour la Meilleure Interprétation Féminine - Série TV 2025.",
    country_id: "Sénégal",
    category_name: "Meilleure Interprétation Féminine Africaine – Série TV",
    category_slug: "meilleure-interpretation-feminine-serie-tv",
  ...
  },
  {
    ...
    first_name: "Moussa",
    last_name: "SOW",
    stage_name: "Moussa Sow",
    slug: "moussa-sow-2025",
    gender: "M",
    portrait_path: "/images/nominee_10_moussa_sow.jpg",
    biography: "Moussa Sow est un acteur sénégalais nommé dans la catégorie Meilleure Interprétation Masculine Africaine – Série TV lors de la 10ème édition (2025) pour sa prestation remarquable dans 'CŒURS BRISES' de Evenprod.",
    short_biography: "Lauréat du prix de la Meilleure Interprétation Masculine - Série TV 2025.",
    country_id: "Sénégal",
    category_name: "Meilleure Interprétation Masculine Africaine – Série TV",
    category_slug: "meilleure-interpretation-masculine-serie-tv",
    film_title: "CŒURS BRISES",
    film_slug: "coeurs-brises",
    is_winner: true,
    is_public_vote_eligible: true
  },
  {
    ...
    first_name: "Fortune",
    last_name: "AKAKPO",
    stage_name: "Fortune Akakpo",
    slug: "fortune-akakpo-2025",
    gender: "M",
    portrait_path: "/images/nominee_10_fortune_akakpo.jpg",
    biography: "Fortune Akakpo est un acteur ivoirien nommé dans la catégorie Meilleure Interprétation Masculine Africaine – Série TV lors de la 10ème édition (2025) pour son rôle dans la série 'LES NOUNOUS' de Franck Vlehi & Marina Niava.",
    short_biography: "Nominé pour la Meilleure Interprétation Masculine - Série TV 2025.",
    country_id: "Côte d'Ivoire",
    category_name: "Meilleure Interprétation Masculine Africaine – Série TV",
    category_slug: "meilleure-interpretation-masculine-serie-tv",
    film_title: "LES NOUNOUS",
  ...
  },
  {
    ...
    first_name: "Femi",
    last_name: "ADEBAYO",
    stage_name: "Femi Adebayo",
    slug: "femi-adebayo-2025",
    gender: "M",
    portrait_path: "/images/nominee_10_femi_adebayo.jpg",
    biography: "Femi Adebayo est un acteur nigérian nommé dans la catégorie Meilleure Interprétation Masculine Africaine – Série TV lors de la 10ème édition (2025) pour sa prestation dans 'SEVENS DOORS' de Femi Adebayo.",
    short_biography: "Nominé pour la Meilleure Interprétation Masculine - Série TV 2025.",
    country_id: "Nigéria",
    category_name: "Meilleure Interprétation Masculine Africaine – Série TV",
    category_slug: "meilleure-interpretation-masculine-serie-tv",
    film_title: "SEVENS DOORS",
    film_slug: "sevens-doors",
    is_winner: false,
    is_public_vote_eligible: true
  },
  {
