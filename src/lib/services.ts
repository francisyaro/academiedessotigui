...
export const MOCK_NOMINEES: Nominee[] = [
  ...
  },
  {
    ...
    last_name: 'KOFFI',
    stage_name: 'Bienvenue Koffi (Lady Nature)',
    slug: 'bienvenue-koffi',
    gender: 'F',
    portrait_path: '/images/laureat_rosine_nguemgaing.jpg',
    biography: 'Bienvenue Koffi, également connue sous le nom de Lady Nature, est nominée pour la Meilleure interprétation féminine africaine dans une série TV pour son rôle marquant dans "Les Nounous".',
  ...
  },
  {
    ...
    last_name: 'ETTIEN',
    stage_name: 'Biggy King',
    slug: 'biggy-king',
    gender: 'M',
    portrait_path: '/images/espoir_serie_tv_jean_francois_ettien.jpg',
    biography: 'Jean-François Ettien, alias Biggy King, brille dans la catégorie Meilleure interprétation masculine africaine de série TV grâce à sa performance dans "Les Nounous".',
  ...
  },
  {
    ...
    biography: 'Le talentueux Ephraïm Oka concourt pour le prix de Meilleur jeune acteur africain pour sa superbe interprétation dans le film "Ebinto".',
  ...
  },
  {
    ...
    biography: 'Le jeune Lionel Bambara est nominé pour le prix de Meilleur jeune acteur africain pour sa performance remarquée dans "L\'ami de mon père".',
    short_biography: 'Nominé pour le Meilleur Jeune Acteur Africain.',
    country_id: 'Burkina Faso',
    category_name: 'Meilleur Jeune Acteur Africain',
    category_slug: 'meilleur-jeune-acteur-africain',
  ...
  },
  {
    ...
    biography: 'Adjetey Anang est un acteur ghanéen de premier ordre, nommé dans la catégorie Meilleur Acteur Nigeria / Ghana pour sa performance d\'exception dans "VIRGIN OF THE THRONE" de Frank Rajah.',
